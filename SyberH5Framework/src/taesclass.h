...
public:
    ...
    void Cipher(unsigned char* input, unsigned char* output);  // encipher 16-bit input 加密16-bit的输入
    void InvCipher(unsigned char* input, unsigned char* output);  // decipher 16-bit input 解密16-bit的输入
private:
